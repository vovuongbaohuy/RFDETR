...
def merge_coco_datasets(
    ...
    and an _annotations.coco.json file) into one dataset with the same split names.
    ...
    for dpath in dataset_paths:
        for split in splits:
            ann_path = dpath / split / "_annotations.coco.json"
    ...
    for split in splits:
        ...
        for dpath in dataset_paths:
            ...
            ann_path = ds_split_dir / "_annotations.coco.json"
            if not ann_path.exists():
...
if __name__ == "__main__":
    dataset_paths = [
        r"data\Nepali_vehicle_dataset_reduced\ambulance", #1
        r"data\Nepali_vehicle_dataset_reduced\auto_rickshaw", #2
        r"data\Nepali_vehicle_dataset_reduced\bikes", #3
        r"data\Nepali_vehicle_dataset_reduced\bus", #4
        r"data\Nepali_vehicle_dataset_reduced\car", #5
        r"data\Nepali_vehicle_dataset_reduced\e-rickshaw", #6
        r"data\Nepali_vehicle_dataset_reduced\micro_bus", #7
        r"data\Nepali_vehicle_dataset_reduced\mini_truck", #8
        r"data\Nepali_vehicle_dataset_reduced\police_vehicle", #9
        r"data\Nepali_vehicle_dataset_reduced\school_bus", #10
        r"data\Nepali_vehicle_dataset_reduced\scooter", #11
        r"data\Nepali_vehicle_dataset_reduced\SUV", #12
        r"data\Nepali_vehicle_dataset_reduced\taxi", #13
        r"data\Nepali_vehicle_dataset_reduced\tempo", #14
        r"data\Nepali_vehicle_dataset_reduced\tractor", #15
